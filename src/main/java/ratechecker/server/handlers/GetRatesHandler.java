 ...
 * @author cherrot
 */
public class GetRatesHandler implements ActionHandler<GetRatesAction, GetRatesResult> {
	...
	@Override
	public Class<GetRatesAction> getActionType() {
		return GetRatesAction.class;
	}

	@Override
	public void rollback(final GetRatesAction action, final GetRatesResult result,
			final ExecutionContext ctx) throws ActionException {
	}
